    ...
    <main className="min-h-screen bg-[#F8FBFF] text-[#0B1744]">
      ...
      <section className="px-8 py-16">
        <div className="mx-auto grid max-w-[1320px] items-center gap-12 lg:grid-cols-[.88fr_1fr]">
          ...
          <div className="relative overflow-hidden rounded-[34px] border border-[#DFE9F7] bg-white p-7 shadow-[0_30px_80px_rgba(16,33,63,.1)]">
      ...
      <section className="bg-[#07133B] px-8 py-16 text-white">
        <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[.8fr_1fr]">
          <div>
            ...
            <h2 className="mt-5 text-4xl font-black tracking-[-0.04em]">Simple, reviewed, and controlled.</h2>
      ...
      <section className="px-8 pb-16">
        <div className="mx-auto flex max-w-[1180px] flex-wrap items-center justify-between gap-6 rounded-[28px] bg-gradient-to-r from-[#17245D] to-[#155EEF] p-8 text-white">
          <div>
            <h2 className="text-3xl font-black tracking-[-0.04em]">Want to discuss partnership fit?</h2>
