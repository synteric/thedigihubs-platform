  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-14">
        <h1 className="text-4xl font-black tracking-[-0.05em] text-text sm:text-5xl">Marketplace</h1>
